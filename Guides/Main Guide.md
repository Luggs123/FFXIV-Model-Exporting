...
And that should be it for the common steps between VRChat and VTubing! Depending on what you plan on using, proceed to the [VRChat](</Guides/VRChat Follow-up Guide.md>) or [[VTubing Follow-up Guide|VTubing guides]]. Good luck!